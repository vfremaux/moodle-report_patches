...
if ($options['help']) {
    $help = "
Scan the code searching for patch refs and loads the patch report table.
Please note it much safer to execute this script with the same uid as web server!
...
Example:
\$sudo -u www-data /usr/bin/php report/patches/cli/scansource.php --host=http://my.virtual.moodle.org
