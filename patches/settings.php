...
$ADMIN->add('reports', new admin_externalpage('reportpatches', get_string('patches', 'report_patches'), "$CFG->wwwroot/$CFG->admin/report/patches/index.php", 'moodle/site:config'));
