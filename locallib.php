...
function report_patches_scan($path) {
    ...
    while ($entry = readdir($dir)) {
        ...
        // Some standard.
        $excludepatterns[] = '__patch'; // Patch meta files
        $excludepatterns[] = '__extras'; // Patch meta files
        $excludepatterns[] = '__other'; // Patch meta files
        $excludepatterns[] = '__reference'; // Reference meta files
        $excludepatterns[] = '__customscripts'; // Customscripts meta files
        $excludepatterns[] = '^x_.*';
        $excludepatterns[] = '^pix$';
        $excludepatterns[] = '^CVS$';
        $excludepatterns[] = '\.git$';
